...
<div class="uk-section uk-margin-top">
  <div class="uk-container">
    ...
    <div class="uk-text-center uk-margin-large-top">
      <div class="uk-text-primary"><span class="uk-margin-small-right"><img src="{{asset('website/img/loader.svg')}}" alt="Loader" width="22" height="22" data-uk-svg></span> Loading More</div>
    </div>    
  </div>
</div>

                                        ...
                                        <tr>
                                         <!--   <td>
                                          ...
                                          <!--  <td><a href="#">Action</a></td> -->
                                            ...
                                            <td>{{$category->name}}</td>
                                            <td> <a href="/delete-category/{{$category->id}}"><i class="fas fa-trash-alt"></i></a> </td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif -->
                            <form method="POST" action="{{ route('dashboroard.category')}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label>Company Name <span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="name" placeholder="Enter the name" id="name">

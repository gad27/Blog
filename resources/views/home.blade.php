                    ...
                    <div class="col-xl-4 col-lg-12 col-md-12">
                        <div class="card">
                            ...
                            <table class="table card-table mt-2">
                                <tbody>
                                    <tr>
                                        <td class="w60"><img class="avatar" src="{{ asset('admin/images/xs/avatar1.jpg')}}" alt="Avatar"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="w60"><img class="avatar" src="{{ asset('admin/images/xs/avatar2.jpg')}}" alt="Avatar"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="w60"><img class="avatar" src="{{ asset('admin/images/xs/avatar3.jpg')}}" alt="Avatar"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="w60"><img class="avatar" src="{{ asset('admin/images/xs/avatar4.jpg')}}" alt="Avatar"></td>
                                        <td>
                                    ...
                                    <tr>
                                        <td class="w60"><img class="avatar" src="{{ asset('admin/images/xs/avatar5.jpg')}}" alt="Avatar"></td>
                                        <td>
